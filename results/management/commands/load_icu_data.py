...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Load the sheet (only one sheet available)
        sensitivity_df = pd.read_excel(file_path, sheet_name='Sheet1')
        # Note: MIC sheet not present in this Excel file
        ...
        # Get admin user (using email as username field)
        ...
        # Note: No MIC data processing since MIC sheet is not available
